...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = React.createClass({
	    ...
	    render: function () {
	        return React.createElement(DataContainer, null);
	    }
	});
	...
	var DataContainer = React.createClass({
	    ...
	    render: function () {
	        ...
	        if (this.state.data.length > 0) {
	            return React.createElement(SampleChart, {
	                ref: 'chart',
	...
	var SampleChart = React.createClass({
	    ...
	    showChart: function (dom) {
	        var chartConfig = {
	            ...
	            tauCharts.api.plugins.get('trendline')(), tauCharts.api.plugins.get('legend')()],
	    ...
	    render: function () {
	        var self = this;
	        return React.createElement('div', { id: 'sample_chrart', ref: function (dom) {
	                self.showChart(dom);
	            } });
	    }
	});
